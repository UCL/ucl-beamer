...
%%% Increase the height of the banner 
% \setbeamertemplate{banner}[large]
...
% \setbeamercolor{banner stripe}{bg=brightblue}

%%% The main structural elements
% \setbeamercolor{structure}{fg=black}

% \setbeamercolor{palette tertiary}{bg=yellow,fg=darkblue}
% \setbeamercolor{palette quaternary}{bg=yellow,fg=darkblue}
...
% \setbeamertemplate{headline}[miniframes][0.5]
